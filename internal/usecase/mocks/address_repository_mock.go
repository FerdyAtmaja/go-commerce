...
func (m *MockAddressRepository) GetByID(id uint) (*domain.Address, error) {
	args := m.Called(id)
	if args.Get(0) == nil {
...
func (m *MockAddressRepository) GetByUserID(userID uint, limit, offset int) ([]*domain.Address, int64, error) {
...
func (m *MockAddressRepository) CheckOwnership(addressID, userID uint) bool {
