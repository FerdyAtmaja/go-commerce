...
type Store struct {
	...
	Status      string         `json:"status" gorm:"column:status;type:enum('active','suspended');default:active;index:idx_toko_status" validate:"omitempty,oneof=active suspended"`
