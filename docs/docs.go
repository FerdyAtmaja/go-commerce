...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/payments/{intentId}/simulate-failed": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/payments/{intentId}/simulate-success": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/stores/{id}/suspend": {
            "put": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Conflict - already suspended",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/admin/stores/{id}/unsuspend": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Store unsuspended successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "409": {
                        "description": "Conflict - not suspended",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.PaymentCallbackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/seller/transactions/{id}/process": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "tags": [
                    "Transactions - Seller Operations"
                ],
        ...
        "/stores/my/activate": {
            "put": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden - store suspended",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "409": {
                        "description": "Conflict - already active or profile incomplete",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/stores/my/deactivate": {
            "put": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Conflict - store not active",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.CreatePaymentIntentRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.PaymentIntentStatus": {
            ...
            "x-enum-varnames": [
                "PaymentIntentStatusPending",
                "PaymentIntentStatusSuccess",
        ...
        "http.CreatePaymentIntentRequest": {
            "type": "object",
            "required": [
                "method"
            ],
